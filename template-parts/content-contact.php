	...
	<div class="entry-content">
		...
		<article class="only-text">
			...
			<section class="row contact-top-row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-sm-push-6 col-md-push-6 col-lg-push-6  wow slideInRight" data-wow-duration="2s" data-wow-delay="1s">
					<img class="img-responsive" src="http://tiana/wp-content/uploads/2016/01/for-contact-pg.jpg" alt="">
				</div>
				
				<div class="col-sm-6 col-md-6 col-lg-6 col-sm-pull-6 col-md-pull-6 col-lg-pull-6 wow slideInLeft" data-wow-duration="2s" data-wow-delay=".5s" >
